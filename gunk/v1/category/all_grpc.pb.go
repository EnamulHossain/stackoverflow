...
type CategoryServiceClient interface {
	...
	UpdateCategory(ctx context.Context, in *UpdateCategoryRequest, opts ...grpc.CallOption) (*UpdateCategoryResponce, error)
}
...
func (c *categoryServiceClient) EditCategory(ctx context.Context, in *EditCategoryRequest, opts ...grpc.CallOption) (*EditCategoryResponse, error) {
	out := new(EditCategoryResponse)
	err := c.cc.Invoke(ctx, "/categorypb.CategoryService/EditCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) UpdateCategory(ctx context.Context, in *UpdateCategoryRequest, opts ...grpc.CallOption) (*UpdateCategoryResponce, error) {
	out := new(UpdateCategoryResponce)
...
type CategoryServiceServer interface {
	...
	UpdateCategory(context.Context, *UpdateCategoryRequest) (*UpdateCategoryResponce, error)
...
func (UnimplementedCategoryServiceServer) EditCategory(context.Context, *EditCategoryRequest) (*EditCategoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EditCategory not implemented")
}
func (UnimplementedCategoryServiceServer) UpdateCategory(context.Context, *UpdateCategoryRequest) (*UpdateCategoryResponce, error) {
...
func _CategoryService_EditCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/categorypb.CategoryService/EditCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "stackoverflow/gunk/v1/category/all.proto",
}
